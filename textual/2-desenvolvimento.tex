...
apenas o recuo \cite{NBR10520:2002}.
\end{citacao}
\end{verbatim}
...
\begin{figure}[htb]
	...
	\end{center}
	\legend{Fonte: \textcite[p. 24]{araujo2012}}
\end{figure}
...
\begin{equation}
  ...
  \label{eq:teste}
  \nomenclature[A]{ABC}{Teste sigla}
  \nomenclature[S]{$A_i$}{Symbol test}
\end{equation}

Escreva expressões matemáticas entre \$ e \$, como em $ \lim_{x \to \infty}
\exp(-x) = 0 $, para que fiquem na mesma linha de \autoref{eq:teste}.

Para colocar símbolos e/ou siglas, basta digitar:

\begin{verbatim}
  \nomenclature[A]{ABC}{Teste sigla}
  \nomenclature[S]{$A_i$}{Símbolo de teste}
\end{verbatim}

Estes dois comando atualizam automaticamente as listas. Os argumentos dentro dos 
colchetes, \verb|A| e \verb|S| definem entre sigla e símbolo, respectivamente.
...
Isso atende à norma \textcite{NBR14724:2011} e \textcite{NBR6024:2012}.
